 ...
 *
 */
@RestController  //http:locathost:8080/get_by_cids?cids=1&cids=2&cids=3&cids=4&cids=5
...
public class CartController extends BaseController{
	...
	public JsonResult<Integer> addNum(@PathVariable("cid") Integer cid,@PathVariable("session")HttpSession session){
		Integer uid = getUidFromSession(session);
		String username=getUsernameFromSession(session);
